...
public class Gittest {
  ...
  @Test
  public void Gittes() throws Exception {
	CsvReader cr =  new CsvReader("G:/eclipse/SeleniumTest/inputgit.csv", ',',Charset.forName("GBK"));
	cr.readHeaders();
	while (cr.readRecord()) {
		id = cr.get(0);
		gitAddress = cr.get(2);
	    ...
	    new Select(driver.findElement(By.id("gender"))).selectByVisibleText("ÄÐ");
